...
class TestGitHubTools(unittest.TestCase):
    def setUp(self):
        ...
        self.comment_mock.html_url = "https://github.com/owner/repo/pull/123#issuecomment-456"
    ...
    def test_get_pull_request_diff_tool(self):
        ...
        result = tool.execute({"repo": "owner/repo", "pr_number": 123, "filename": "test.py"})
        
        self.github_mock.get_repo.assert_called_once_with("owner/repo")
        self.repo_mock.get_pull.assert_called_once_with(123)
        self.pr_mock.get_files.assert_called_once()
        
        self.assertEqual(result, "@@ -1,5 +1,10 @@\n+# New line\n def test():\n-    return 'old'\n+    return 'new'\n")
    ...
    def test_add_pull_request_comment_tool(self):
        ...
        self.github_mock.get_repo.assert_called_once_with("owner/repo")
        self.repo_mock.get_pull.assert_called_once_with(123)
        self.pr_mock.create_issue_comment.assert_called_once_with("This is a test comment")
        
        self.assertEqual(result["id"], 456)
        self.assertEqual(result["url"], "https://github.com/owner/repo/pull/123#issuecomment-456")
