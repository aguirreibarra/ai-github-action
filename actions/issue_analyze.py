...
class IssueAnalyzeAction:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            issue_info = self.agent.execute_tool("get_issue", {
                "repo": repo_name,
            ...
            self.agent.execute_tool("add_issue_comment", {
                "repo": repo_name,
                "issue_number": issue_number,
            ...
            for line in lines:
                if "summary" in line.lower():
                    ...
                    continue
                elif "suggest" in line.lower() or "next step" in line.lower() or "recommend" in line.lower():
